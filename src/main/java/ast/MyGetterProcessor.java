...
/**
 * 依次执行下面命令编译:
 * <li>javac -encoding UTF-8 -cp "D:\Program Files\jdk\jdk1.8\lib\tools.jar" ast/MyGetter* -d .
 * <li>javac -encoding UTF8 -processor ast.MyGetterProcessor ast/Person.java <br>
 * <li>javap -p Person.class
 *
 *     <p>这个就是lombok的原理
 */
...
public class MyGetterProcessor extends AbstractProcessor {
          ...
          tree.accept(
              new TreeTranslator() {
                ...
                public void visitClassDef(JCTree.JCClassDecl jcClassDecl) {
                  ...
                  // 对于变量进行生成方法的操作
                  jcVariableDeclList.forEach(
                      jcVariableDecl -> {
                        messager.printMessage(
                            Diagnostic.Kind.NOTE, jcVariableDecl.getName() + " has been processed");
                        jcClassDecl.defs =
  ...
  private JCTree.JCExpressionStatement makeAssignment(
      JCTree.JCExpression lhs, JCTree.JCExpression rhs) {
